...
function setup() {
  ...
  ground = createSprite(width/2,height-110,width-10,125);
  ...
  restart = createSprite(width/2,(height/3)+30, 10, 10);
  ...
  invisibleGround = createSprite(width/2,height-50,width-10,125);
